  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-3 mb-5">
        ...
        <StatCard label="Submitted by Maker" value={(stats?.submittedByMaker || 0).toString()} icon={<MakerIcon />} color="bg-indigo-50 text-indigo-600" delay="fade-in fade-in-delay-3" href="/reports" />
...
function MakerIcon() { return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" /><polyline points="14,2 14,8 20,8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></svg>; }
